...
public enum ErrorCode {
    ...
    PASSWORD_MISMATCH(HttpStatus.UNAUTHORIZED, "AUTH_4024", "아이디 또는 비밀번호가 일치하지 않습니다.",
            "아이디나 비밀번호가 맞지 않아요. 다시 입력해 주세요."),
    PASSWORD_LOCKED(HttpStatus.FORBIDDEN, "AUTH_4025", "로그인 실패 제한 횟수를 초과했습니다.",
            "여러 번 잘못 입력하셨어요. 오 분 뒤에 다시 시도해 주세요."),
    PASSWORD_NOT_REGISTERED(HttpStatus.BAD_REQUEST, "AUTH_4026", "일반 로그인 비밀번호가 등록되어 있지 않습니다.",
            "이 계정은 카카오로 로그인해 주세요."),
    LOGIN_ID_ALREADY_REGISTERED(HttpStatus.CONFLICT, "AUTH_4092", "이미 사용 중인 아이디입니다.",
            "이미 쓰고 있는 아이디예요. 다른 아이디를 정해 주세요."),
    ...
    INVALID_ACCOUNT_NUMBER(HttpStatus.BAD_REQUEST, "TRANSFER_4008",
            "계좌번호 형식이 올바르지 않습니다.",
            "계좌번호를 숫자로 다시 말씀해 주세요."),
    BANK_CODE_MISSING(HttpStatus.BAD_REQUEST, "TRANSFER_4010",
            "은행을 알 수 없습니다.",
            "어느 은행 계좌인가요? 은행 이름을 말씀해 주세요."),
    RECIPIENT_ACCOUNT_UNVERIFIED(HttpStatus.BAD_REQUEST, "TRANSFER_4011",
            "예금주를 확인하지 못한 계좌입니다.",
            "그 계좌를 확인하지 못했어요. 은행과 계좌번호를 다시 말씀해 주세요."),
    RECIPIENT_UNVERIFIED(HttpStatus.BAD_REQUEST, "TRANSFER_4012",
            "계좌 확인이 끝나지 않은 수취인입니다.",
            "저장된 계좌를 확인하지 못했어요. 계좌번호를 다시 등록해 주세요."),
